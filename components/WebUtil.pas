...
* Change Log:
* $Log: WebUtil.pas,v $
* Revision 1.6.2.1  2005/08/29 14:08:47  z_stoichev
* Merged with HEAD Web Update fixes.
*
* Revision 1.7  2005/04/08 10:31:39  z_stoichev
* Do not encode, but only decode space char.
*
