...
type
  ...
  TBaudRate = (brCustom, br110, br300, br600, br1200, br2400, br4800, br9600, br14400,
    br19200, br38400, br56000, br57600, br115200, br128000, br256000, br230400, br460800, br921600);
  ...
  TCustomComDataPacket = class(TComponent)
  private
    FComLink: TComLink;
    FComPort: TCustomComPort;
    FStartString: string;
  ...
  TComDataPacket = class(TCustomComDataPacket)
  published
    property ComPort;
    ...
    property OnDiscard;
    property OnPacket;
    property OnCustomStart;
    property OnCustomStop;
  end;
...
// create component
constructor TCustomComDataPacket.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
...
// destroy component
destructor TCustomComDataPacket.Destroy;
begin
  ComPort := nil;
  FComLink.Free;
  inherited Destroy;
...
procedure TCustomComDataPacket.AddData(const Str: string);
begin
  if ValidStop then
  begin
    Buffer := Buffer + Str;
...
procedure TCustomComDataPacket.Notification(AComponent: TComponent;
...
// call OnDiscard
procedure TCustomComDataPacket.DoDiscard(const Str: string);
begin
...
// call OnPacket
procedure TCustomComDataPacket.DoPacket(const Str: string);
begin
...
// call OnCustomStart
procedure TCustomComDataPacket.DoCustomStart(const Str: string;
  var Pos: Integer);
begin
...
// call OnCustomStop
procedure TCustomComDataPacket.DoCustomStop(const Str: string; var Pos: Integer);
begin
...
procedure TCustomComDataPacket.CheckIncludeStrings(var Str: string);
var
...
// upper case
function TCustomComDataPacket.Upper(const Str: string): string;
begin
...
procedure TCustomComDataPacket.HandleBuffer;
...
function TCustomComDataPacket.ValidStop: Boolean;
begin
...
// receive data
procedure TCustomComDataPacket.RxBuf(Sender: TObject; const Buffer; Count: Integer);
var
  Str: string;
...
// empty buffer
procedure TCustomComDataPacket.EmptyBuffer;
begin
  if Buffer <> '' then
  begin
    try
...
// set com port
procedure TCustomComDataPacket.SetComPort(const Value: TCustomComPort);
begin
...
procedure TCustomComDataPacket.SetCaseInsensitive(const Value: Boolean);
begin
...
// set packet size
procedure TCustomComDataPacket.SetSize(const Value: Integer);
begin
  if FSize <> Value then
  begin
    FSize := Value;
...
// set start string
procedure TCustomComDataPacket.SetStartString(const Value: string);
begin
...
// set stop string
procedure TCustomComDataPacket.SetStopString(const Value: string);
begin
...
const
  BaudRateStrings: array[TBaudRate] of string = ('Custom', '110', '300', '600',
    ...
    '115200', '128000', '256000', '230400', '460800', '921600');
begin
