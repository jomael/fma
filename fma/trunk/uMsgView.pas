...
* Change Log:
* $Log: uMsgView.pas,v $
* Revision 1.47.2.51  2006/03/12 13:04:31  z_stoichev
* New UTF8 Codec usage.
*
* Revision 1.47.2.50  2006/03/11 15:18:07  z_stoichev
* GUI improvements.
*
* Revision 1.47.2.49  2006/03/10 15:29:08  z_stoichev
* fixed command line switch FIXDB usage.
*
* Revision 1.47.2.48  2006/03/10 13:55:58  z_stoichev
* Added Repair DB button to Switch Profiles dialog.
*
* Revision 1.47.2.47  2006/03/10 12:26:14  z_stoichev
* Updated FixDB func, and code cleanup.
*
* Revision 1.47.2.46  2006/03/09 23:03:00  mhr3
* - Added "Fix messages database" menuitem to Advanced popup menu
* - Added DoFixMessageDB procedure
* - Fixed GetNodeLongText not working with duplicated SMS
*
* Revision 1.47.2.45  2006/03/09 16:03:37  z_stoichev
* Fixed Sending UCS2 Long SMSes.
*
* Revision 1.47.2.44  2006/03/09 09:13:01  z_stoichev
* Gsm_SMS code merged into uSMS.pas!
*
* Revision 1.47.2.43  2006/02/23 15:43:14  z_stoichev
* Fixed Gradient fills removed on few places.
*
* Revision 1.47.2.42  2006/02/23 10:49:42  z_stoichev
* Code small fix.
*
* Revision 1.47.2.41  2006/02/21 21:25:47  mhr3
* Fixed possible lock during Export
* CSV export is now UTF-8 encoded
*
* Revision 1.47.2.40  2006/02/21 20:52:58  mhr3
* Speed optimized for deleting messages
*
* Revision 1.47.2.38  2006/02/08 18:05:52  mhr3
* fixed DeselectAll
*
* Revision 1.47.2.37  2006/02/02 10:08:16  z_stoichev
* - Fixed Text Messages view display speed.
*
* Revision 1.47.2.36  2006/01/30 16:32:37  z_stoichev
* - Fixed Messages View controls tab order.
*
* Revision 1.47.2.35  2006/01/25 12:01:37  z_stoichev
* - Fixed Refresh large text messages folder GUI.
* - Fixed Display long SMS text in the SMS list.
* - Fixed SMS list selection changed, GUI update.
*
* Revision 1.47.2.34  2006/01/23 16:19:26  z_stoichev
* - Added Search text Messages panel Auto-hide.
* - Added Send SMS Later from Phone popup option.
*
* Revision 1.47.2.33  2006/01/23 11:29:07  z_stoichev
* GUI changes.
*
* Revision 1.47.2.32  2006/01/20 13:54:09  z_stoichev
* Search fixes. Added auto-search timer.
*
* Revision 1.47.2.31  2006/01/20 09:22:08  mhr3
* changed message searching
*
* Revision 1.47.2.30  2006/01/16 11:26:57  mhr3
* Form1.Explorer -> Form1.ExplorerNew
*
* Revision 1.47.2.29  2005/12/21 13:27:44  z_stoichev
* Added Search SMS popup option (Advanced, F3).
* Fixed Show/Move/Copy/Export long SMS AV bugs.
*
* Revision 1.47.2.28  2005/12/21 10:54:38  z_stoichev
* Added Search Messages (F3).
*
* Revision 1.47.2.27  2005/12/15 11:52:49  z_stoichev
* Fixed Delete in phone will check for same PDU.
*
* Revision 1.47.2.26  2005/11/03 13:02:38  z_stoichev
* fixed Upload To popup menu option
*
* Revision 1.47.2.25  2005/10/04 15:11:57  z_stoichev
* GUI Fixes
*
* Revision 1.47.2.24  2005/10/02 22:35:55  z_stoichev
* - Added Message View popup menu Advanced options.
* - Added Message View popup menu Mark All as Read.
*
* Revision 1.47.2.23  2005/09/30 14:47:31  z_stoichev
* Fixes
*
* Revision 1.47.2.22  2005/09/30 12:18:19  z_stoichev
* Fixes
*
* Revision 1.47.2.21  2005/09/21 14:24:36  z_stoichev
* Added Message Preview popup menu commands.
*
* Revision 1.47.2.20  2005/09/20 23:22:50  z_stoichev
* no message
*
* Revision 1.47.2.19  2005/09/20 13:57:14  z_stoichev
* Move to Folder multiple messages.
*
* Revision 1.47.2.18  2005/09/20 11:57:29  z_stoichev
* - Added Create user Text Messages folders.
* - Added Move Messages to custom folder.
*
* Revision 1.47.2.17  2005/09/19 21:03:45  z_stoichev
* Key Enter press and Properties update fixes.
*
* Revision 1.47.2.16  2005/09/19 13:17:14  z_stoichev
* Properties Toolbar button initial click issue fixed.
* Added Text messages folders Incremental search.
*
* Revision 1.47.2.15  2005/09/19 12:19:04  z_stoichev
* Added Command line switch "/fixdb" to clean DB.
*
* Revision 1.47.2.14  2005/09/16 10:21:03  z_stoichev
* Changed Popup menu options/text.
*
* Revision 1.47.2.13  2005/09/15 23:35:31  z_stoichev
* Changed popup menu.
*
* Revision 1.47.2.12  2005/09/06 18:32:55  z_stoichev
* Bugfixes and improvements (2.1.1.102b)
*
* Revision 1.47.2.11  2005/08/31 12:18:01  z_stoichev
* - Fixed AV error when Explorer Node.Data is nil.
*
* Revision 1.47.2.10  2005/08/31 11:50:56  z_stoichev
* - Fixed replay on long message btnLong.Down change.
* - Messages in Outbox or Drafts are always Unread.
* - Fixed First double-click in Messages folder.
*
* Revision 1.47.2.9  2005/08/30 13:39:47  z_stoichev
* Fixed GetNodeLongList on lookup failure.
*
* Revision 1.47.2.8  2005/08/30 12:54:13  z_stoichev
* Fixed Show Long SMS details contains all PDUs.
*
* Revision 1.47.2.7  2005/08/23 20:59:58  z_stoichev
* - Changed Text Message properties dialog GUI.
*
* Revision 1.47.2.6  2005/08/22 17:37:38  z_stoichev
* - Fixed Messages Folder name lookup thread removed.
* - Fixed Text Messages sorted by name column issue.
*
* Revision 1.47.2.5  2005/08/22 12:50:39  z_stoichev
* - Fixed Move to Phone (upload) text messages.
* - Fixed Delete text Message from SIM archive.
*
* Revision 1.47.2.4  2005/08/20 18:13:37  z_stoichev
* - Fixed LookupContact, LookupNumber, ContactNumberByName.
* - Fixed Find contact in Phonebook (Irmc), Phone Book, SIM.
*
* Revision 1.47.2.3  2005/08/18 17:13:47  z_stoichev
* - Added support for JPEG2000 images.
* - Fixed GIF images displaying issue.
*
* Revision 1.47.2.2  2005/04/10 17:44:58  z_stoichev
* Fixed delete/move to archive text message.
*
* Revision 1.47.2.1  2005/04/09 17:20:00  lordlarry
* Changed: Destroy to Free and added some try..finally structures
*
* Revision 1.47  2005/03/14 09:27:51  z_stoichev
* Added 'Export to unsupported Import' format warning.
*
* Revision 1.46  2005/03/02 17:57:46  voxik
* Removed obsolete Unicode unit
*
* Revision 1.45  2005/02/19 12:17:17  lordlarry
* Changed Log Messages Category and Severity (Removing the Debug method)
*
* Revision 1.44  2005/02/08 15:38:52  voxik
* Merged with L10N branch
*
* Revision 1.38.12.5  2005/02/07 23:32:44  voxik
* Fixed Unicode debug logs
*
* Revision 1.38.12.4  2005/02/02 23:15:52  voxik
* Changed MessageDlg and ShowMessages replaced by new unicode versions
*
* Revision 1.38.12.3  2005/01/07 17:34:31  expertone
* Merge with MAIN branch
*
* Revision 1.43  2005/01/03 16:11:35  z_stoichev
* - Fixed: Copy/move Long SMS to Archive.
* - Changed: Message view details GUI changes.
*
* Revision 1.42  2004/12/23 12:07:34  z_stoichev
* Fixed missing event
*
* Revision 1.41  2004/12/23 10:18:04  z_stoichev
* Fixed component name
*
* Revision 1.40  2004/12/23 09:55:02  z_stoichev
* Fixed remember column headers settings
*
* Revision 1.39  2004/12/15 15:47:22  z_stoichev
* Merged with Long SMS branch.
*
* Revision 1.38.10.3  2004/12/15 15:20:11  z_stoichev
* Do not show long sms as flatten text.
*
* Revision 1.38.10.2  2004/12/15 13:38:08  z_stoichev
* Long SMS support bugfixes.
* Mark Long SMS as one (read/unread).
*
* Revision 1.38.10.1  2004/09/15 10:02:37  z_stoichev
* Added Long SMS View/Details support
*
* Revision 1.38.12.2  2004/10/25 20:21:46  expertone
* Replaced all standart components with TNT components. Some small fixes
*
* Revision 1.38.12.1  2004/10/19 19:48:38  expertone
