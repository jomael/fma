...
* Revision 1.62.2.22  2006/03/12 13:04:31  z_stoichev
* New UTF8 Codec usage.
*
* Revision 1.62.2.21  2006/01/25 12:02:07  z_stoichev
* Compiler warning fix.
*
* Revision 1.62.2.20  2006/01/24 14:17:24  z_stoichev
* Fixed Incorrect Phonebook Sync 'CC.LOG' values.
*
* Revision 1.62.2.19  2006/01/16 11:26:57  mhr3
* Form1.Explorer -> Form1.ExplorerNew
*
* Revision 1.62.2.18  2005/12/07 10:52:36  mhr3
* Added export contacts to .LDIF file (Thunderbird)
*
* Revision 1.62.2.17  2005/11/12 19:43:50  mhr3
* added support to import contacts from Thunderbird .ldif files
*
* Revision 1.62.2.16  2005/09/20 14:44:57  z_stoichev
* Changed Confirmations default button to NO.
*
* Revision 1.62.2.15  2005/09/19 12:19:04  z_stoichev
* Added Command line switch "/fixdb" to clean DB.
*
* Revision 1.62.2.14  2005/09/18 21:19:04  z_stoichev
* Code cleanup.
*
* Revision 1.62.2.13  2005/09/18 20:34:03  z_stoichev
* Add to Phonebook fixes.
* Avoid dublicate adds (ERROR response).
*
* Revision 1.62.2.12  2005/09/17 15:19:36  z_stoichev
* Add to Group fixes.
*
* Revision 1.62.2.11  2005/09/17 12:07:25  z_stoichev
* Add to Group fixes.
*
* Revision 1.62.2.10  2005/09/16 10:20:01  z_stoichev
* Fixed sync message uniform.
*
* Revision 1.62.2.9  2005/09/15 15:00:49  z_stoichev
* Changed popup menu.
*
* Revision 1.62.2.8  2005/09/06 18:32:57  z_stoichev
* Bugfixes and improvements (2.1.1.102b)
*
* Revision 1.62.2.7  2005/09/01 13:43:25  z_stoichev
* Added Resolve Conflict Show Changes support.
*
* Revision 1.62.2.6  2005/08/30 12:55:43  z_stoichev
...
*
* Revision 1.62.2.5  2005/08/24 14:36:18  z_stoichev
* - Synchronization display messages are uniform now.
*
* Revision 1.62.2.4  2005/08/24 13:14:48  z_stoichev
* - Fixed Contacts Database loading and parsing.
* - Fixed Contacts Database Unicode support.
*
* Revision 1.62.2.3  2005/08/20 18:13:38  z_stoichev
* - Fixed LookupContact, LookupNumber, ContactNumberByName.
* - Fixed Find contact in Phonebook (Irmc), Phone Book, SIM.
*
* Revision 1.62.2.2  2005/04/11 23:18:36  z_stoichev
* Fixed Conatcts Database Unicode issue.
*
* Revision 1.62.2.1  2005/04/03 12:22:11  lordlarry
* Changed some methods to WideString methods
*
* Revision 1.62  2005/03/14 09:51:50  z_stoichev
* Added: Phonebook Sync verbose progress messages.
* Added: Set default DisplayName on imported contacts.
*
* Revision 1.61  2005/03/14 08:58:30  z_stoichev
* Fixed SetDisplayName record usage.
* Check for and clear default DN setting.
* SetDisplayName for FMA created contact.
*
* Revision 1.60  2005/03/13 10:46:51  schnorbsl_fma
* added: set default DisplayName with import contact from phone
*
* Revision 1.59  2005/03/09 23:28:36  schnorbsl_fma
* changed: appearance of column DisplayName; fixed: bug in "Full Name" display LastFirst
*
* Revision 1.58  2005/03/08 10:33:56  z_stoichev
* Fixed: Phonebook display name default setting.
* Fixed: Remember columns visibility setting.
* Added: Main popup menu submenus from header popups.
*
* Revision 1.57  2005/03/07 19:34:06  schnorbsl_fma
* Changed: columns are hideable now, new column DisplayName, modified column FullName
*
* Revision 1.56  2005/03/04 00:10:10  schnorbsl_fma
* added: scroll focused entry into view after sorting;
* minor bug fix with csv export
*
* Revision 1.55  2005/03/02 17:57:47  voxik
* Removed obsolete Unicode unit
*
* Revision 1.54  2005/02/24 21:29:15  lordlarry
...
*
* Revision 1.53  2005/02/19 12:51:01  lordlarry
* Changed Log Messages Category and Severity (Removing the SyncLog method)
*
* Revision 1.52  2005/02/19 12:02:02  lordlarry
* Changed Log Messages Category and Severity (Removing the Debug method)
*
* Revision 1.51  2005/02/14 10:23:55  z_stoichev
* Export contacts as Opera contacts file.
*
* Revision 1.50  2005/02/12 18:18:13  lordlarry
* Changed: The right click menu only apears on the name column (Schnorbsl)
*
* Revision 1.49  2005/02/10 20:07:31  lordlarry
* New way of Logging
*
* Revision 1.48  2005/02/09 21:07:41  voxik
* Fixed Message dialog text
*
* Revision 1.47  2005/02/09 18:32:10  lordlarry
* Address support by Schnorbsl
*
* Revision 1.46  2005/02/09 14:01:45  z_stoichev
* Fixed #13#10 to sLinebreak.
*
* Revision 1.45  2005/02/08 15:38:55  voxik
* Merged with L10N branch
*
* Revision 1.43.2.4  2005/02/02 23:15:54  voxik
* Changed MessageDlg and ShowMessages replaced by new unicode versions
*
* Revision 1.43.2.3  2005/01/07 17:34:38  expertone
* Merge with MAIN branch
*
* Revision 1.44  2004/12/14 11:21:45  z_stoichev
...
*
* Revision 1.43.2.2  2004/10/25 20:21:57  expertone
* Replaced all standart components with TNT components. Some small fixes
*
* Revision 1.43.2.1  2004/10/19 19:48:49  expertone
* Add localization (gnugettext)
*
* Revision 1.43  2004/10/15 14:01:59  z_stoichev
* Merged with Stable bugfixes
*
* Revision 1.42  2004/09/10 06:47:26  z_stoichev
* Fixed a typo in Outlook Details
* Added Outlook Details default number
*
* Revision 1.41  2004/09/08 19:18:42  lordlarry
