...
* Change Log:
* $Log: uInfoView.pas,v $
* Revision 1.28.2.9  2006/01/16 11:26:56  mhr3
* Form1.Explorer -> Form1.ExplorerNew
*
* Revision 1.28.2.8  2005/11/24 15:03:15  z_stoichev
* Fixed default theme font usage. Do not alter FORM's font property!
*
* Revision 1.28.2.7  2005/10/04 10:05:28  expertone
* L10N Fixes
*
* Revision 1.28.2.6  2005/10/02 22:35:13  z_stoichev
* Fixed FMA Today SMS Counter for custom folders.
* Added FMA Today page Properties tool button.
*
* Revision 1.28.2.5  2005/10/01 10:12:05  z_stoichev
* WideQuoteStr function fixes.
*
* Revision 1.28.2.4  2005/09/19 22:46:48  z_stoichev
* Updated for Messages Sync.
*
* Revision 1.28.2.3  2005/09/17 12:10:40  z_stoichev
* Added Sync All link.
* Changed some icons.
*
* Revision 1.28.2.2  2005/09/06 18:32:55  z_stoichev
* Bugfixes and improvements (2.1.1.102b)
*
* Revision 1.28.2.1  2005/08/20 18:13:37  z_stoichev
...
*
* Revision 1.27  2005/02/08 15:38:52  voxik
* Merged with L10N branch
*
* Revision 1.20.2.4  2005/01/07 17:34:31  expertone
* Merge with MAIN branch
*
* Revision 1.26  2004/12/23 09:56:17  z_stoichev
* Fixed reported contacts count numer.
*
* Revision 1.25  2004/12/13 15:33:54  z_stoichev
* - Changed: Made Battery monitoring optional.
* - Changed: Made Signal monitoring optional.
* - GUI changes and bugfixes.
*
* Revision 1.24  2004/12/11 15:57:38  z_stoichev
* GUI Fixes
*
* Revision 1.23  2004/12/11 12:13:28  z_stoichev
* GUI changes
*
* Revision 1.22  2004/12/11 11:38:53  z_stoichev
* Page reorganized to allow more Personal Data space.
*
* Revision 1.21  2004/12/10 16:08:00  z_stoichev
* Fixed: Fma Today page link text/positions.
* Added: New Fma Today links.
*
* Revision 1.20.2.3  2004/11/01 21:26:55  expertone
* Fixed some BiDi problems
*
* Revision 1.20.2.2  2004/10/25 20:21:46  expertone
* Replaced all standart components with TNT components. Some small fixes
*
* Revision 1.20.2.1  2004/10/19 19:48:38  expertone
* Add localization (gnugettext)
*
* Revision 1.20  2004/10/11 13:15:44  voxik
...
*
* Revision 1.18.2.1  2004/07/02 10:18:02  z_stoichev
